...
class CameraReceiver():
    def __init__(self):
        ...
        #cv2.createTrackbar("Sh", "W", 225, 255, lambda x:x)
        #cv2.createTrackbar("Vh", "W", 225, 255, lambda x:x)
        
        #self.Hl_w = cv2.getTrackbarPos("Hl", "W")
        #self.Sl_w = cv2.getTrackbarPos("Sl", "W")
        #self.Vl_w = cv2.getTrackbarPos("Vl", "W")
        #self.Hh_w = cv2.getTrackbarPos("Hh", "W")
        #self.Sh_w = cv2.getTrackbarPos("Sh", "W")
        #self.Vh_w = cv2.getTrackbarPos("Vh", "W")
    ...
    def Callback(self, data):
        ...
        left_fit, right_fit, avex, avey, leftx_current, lefty, rightx_current, righty = self.warp_process_image(warp_img)
    ...
    def warp_process_image(self, img):
        ...
        #lower_white = np.array([self.Hl_w, self.Sl_w, self.Vl_w])
        #upper_white = np.array([self.Hh_w, self.Sh_w, self.Vh_w])
